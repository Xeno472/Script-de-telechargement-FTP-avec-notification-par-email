# Paramètres
$ftpServer = "ftp://192.168.2.3"  # Remplacez par l'adresse de votre serveur FTP
$ftpUsername = "ftpuser"       # Nom d'utilisateur FTP
$ftpPassword = "APV47230-28210aK"          # Mot de passe FTP
$remoteFile = "home/ftpuser/ftp/files/var.tar.gz"                   # Nom de l'archive à récupérer
$localPath = "C:\Archives\var.tar.gz"          # Chemin local pour enregistrer l'archive
...
$emailFrom = "daille.clement@gmail.com"           # Adresse email de l'expéditeur
$emailPassword = "JemangedeschenillesViolettes*47230!"       # Mot de passe de l'expéditeur
$emailTo = "clement.daille47@gmail.com"                   # Adresse email de l'administrateur
